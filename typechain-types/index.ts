...
export type { CollateralToken } from "./contracts/CollateralToken";
export { CollateralToken__factory } from "./factories/contracts/CollateralToken__factory";
export type { Lock } from "./contracts/Lock";
export { Lock__factory } from "./factories/contracts/Lock__factory";
export type { SyntheticAsset } from "./contracts/SyntheticAsset";
export { SyntheticAsset__factory } from "./factories/contracts/SyntheticAsset__factory";
